...
- Store View Scope: Scope of a specific store view only
  When create admin user, You can assign scope of the user, each user can belong to one scope, user of a scope can view data of his/her scope and children scopes
