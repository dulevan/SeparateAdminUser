...
class CollectionLimitStore
{
    ...
    public function beforeAddStoreFilter(\Magento\Reports\Model\ResourceModel\Quote\Collection $collection, $storeIds){
    ...
    public function beforeLoad(\Magento\Reports\Model\ResourceModel\Quote\Collection $collection){
        if($this->_helper->isRootAdmin())
        {
            return null;
        }
